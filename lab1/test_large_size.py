...
def show_symbol_array():
    ...
    label_symbols.config(text=" ".join(displayed_array), font=("Helvetica", 40))
...
def save_results():
    with open('test_results_large_size.csv', mode='a', newline='', encoding='UTF-8') as file:
...
root = tk.Tk()
root.title("Тест на запоминание символов БОЛЬШОГО размера")
